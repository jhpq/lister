...
class RConfig{
    ...
    //
    public $no_of_directories   = 2; // 2 dirs = "/compras/api"
    // Set api URL for internal calls

    public $api_url             = 'http://192.168.1.239/lister/api/v2';
    //public $api_url             = 'http://localhost/compras/api/v2';
     ...
     *
     */
    // SQL Server 2008 RC2 - DEVELOPMENT
